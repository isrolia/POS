 ...
 * @author Isrolia
 */
public class ManajemenLaporan extends javax.swing.JFrame {

    /**
     * Creates new form IdentitasAplikasi
     */
    public ManajemenLaporan() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManajemenLaporan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManajemenLaporan().setVisible(true);
            }
        });
    }
